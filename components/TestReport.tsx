  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-8 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-slate-900/50 border border-slate-800 p-5 rounded-xl backdrop-blur-sm relative overflow-hidden group">
           ...
           <div className="flex items-baseline gap-2">
             <span className={`text-3xl font-bold ${successRate === 100 ? 'text-emerald-400' : successRate > 80 ? 'text-blue-400' : 'text-red-400'}`}>
               {successRate}%
             </span>
        ...
        <div className="bg-slate-900/50 border border-slate-800 p-5 rounded-xl backdrop-blur-sm relative overflow-hidden group">
           ...
           <div className="flex items-baseline gap-2">
             ...
             <span className="text-xs text-slate-500">steps executed</span>
           </div>
        ...
        <div className="bg-slate-900/50 border border-slate-800 p-5 rounded-xl backdrop-blur-sm relative overflow-hidden group">
           ...
           <div className="flex items-baseline gap-2">
             ...
             <span className="text-xs text-slate-500">ms / step</span>
           </div>
           <p className="text-xs text-slate-500 mt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
        ...
        <div className="lg:col-span-4 bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-sm flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Code Block */}
        <div className="bg-[#0d1117] border border-slate-800 rounded-xl overflow-hidden flex flex-col h-[600px] shadow-sm">
          ...
          <div className="p-4 overflow-auto flex-1 font-mono text-xs md:text-sm leading-relaxed custom-scrollbar">
        ...
        {/* Execution Logs */}
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden flex flex-col h-[600px] shadow-sm">
           <div className="bg-slate-900 p-4 border-b border-slate-800 flex items-center justify-between">
              <div className="flex items-center gap-2 text-slate-300 font-medium text-sm">
                <Terminal size={16} className="text-emerald-400" />
                <span>Execution Logs</span>
              </div>
              <span className="text-xs text-slate-500">{suite.steps.length} steps logged</span>
           </div>
